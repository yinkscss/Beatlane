...
- Include hard/tricky obstacles (multi-lane bridges/hooks, fakes) but never four-lane simultaneous walls; no hold / long_hold tiles; difficulty should progress cold→hard with an endless feel (star/goals not reached too early)
